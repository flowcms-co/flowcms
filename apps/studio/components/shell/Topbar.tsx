...
const Topbar = ({ onMenu }: { onMenu: () => void }) => {
    ...
    return (
        <header className="pt-safe-2 pb-2.5 sticky top-0 z-30 flex min-h-16 items-center gap-3 bg-surface px-4 shadow-[0_2px_12px_-2px_rgba(26,26,46,0.12)] lg:static lg:min-h-0 lg:h-20 lg:gap-4 lg:pt-0 lg:pb-0 lg:bg-transparent lg:px-6 lg:shadow-none dark:bg-dark-2 dark:shadow-[0_2px_12px_-2px_rgba(0,0,0,0.5)] lg:dark:bg-transparent lg:dark:shadow-none">
